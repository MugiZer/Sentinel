...
Hamza depends on this file only through API responses and canonical types. Do not require Hamza to understand internal evaluator implementation to build the UI/Botpress layer.
