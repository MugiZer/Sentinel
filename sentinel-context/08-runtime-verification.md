...
Hamza depends on this file only through `/api/verify`, API responses, and canonical types. Do not require Hamza to understand internal fact extraction/evaluator implementation to build the UI/Botpress layer.
